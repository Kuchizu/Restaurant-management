...
public class KitchenController {
    ...
    public KitchenQueueDto addToQueue(
        ...
        return addToQueueUseCase.addToQueue(dto);
    }
    ...
    public List<KitchenQueueDto> getActiveQueue() {
        return getQueueUseCase.getActiveQueue();
    }
    ...
    public List<KitchenQueueDto> getAllQueue() {
        return getQueueUseCase.getAllQueue();
    }
    ...
    public ResponseEntity<Page<KitchenQueueDto>> getAllQueuePaged(
        ...
        Page<KitchenQueueDto> queuePage = getQueueUseCase.getAllQueueItemsPaginated(page, size);
    ...
    public ResponseEntity<Slice<KitchenQueueDto>> getAllQueueInfiniteScroll(
        ...
        Slice<KitchenQueueDto> queueSlice = getQueueUseCase.getAllQueueItemsSlice(page, size);
    ...
    public KitchenQueueDto getQueueItemById(
        ...
        return getQueueUseCase.getQueueItemById(id);
    }
    ...
    public KitchenQueueDto updateStatus(
        ...
        return updateQueueStatusUseCase.updateStatus(id, status);
    }
}
