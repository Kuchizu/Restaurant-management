...
public class InventoryController {
    ...
    private final ManageIngredientUseCase manageIngredientUseCase;
    ...
    public ResponseEntity<List<InventoryDto>> getAllInventory() {
        return ResponseEntity.ok(manageInventoryUseCase.getAllInventory());
    }
    ...
    public ResponseEntity<Page<InventoryDto>> getAllInventoryPaged(
        ...
        Page<InventoryDto> inventory = manageInventoryUseCase.getAllInventoryPaginated(page, size);
    ...
    public ResponseEntity<Slice<InventoryDto>> getAllInventoryInfiniteScroll(
        ...
        Slice<InventoryDto> inventory = manageInventoryUseCase.getAllInventorySlice(page, size);
    ...
    public ResponseEntity<InventoryDto> getInventoryById(
        ...
        return ResponseEntity.ok(manageInventoryUseCase.getInventoryById(id));
    }
    ...
    public ResponseEntity<List<InventoryDto>> getLowStockInventory() {
        return ResponseEntity.ok(manageInventoryUseCase.getLowStockInventory());
    }
    ...
    public ResponseEntity<InventoryDto> createInventory(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(manageInventoryUseCase.createInventory(dto));
    }
    ...
    public ResponseEntity<InventoryDto> updateInventory(
            ...
            @RequestBody InventoryDto dto) {
        return ResponseEntity.ok(manageInventoryUseCase.updateInventory(id, dto));
    }
    ...
    public ResponseEntity<InventoryDto> adjustInventory(
        ...
        return ResponseEntity.ok(manageInventoryUseCase.adjustInventory(id, quantity));
    }
    ...
    public ResponseEntity<Void> deleteInventory(
            @Parameter(description = "ID инвентаря", required = true, example = "1")
            @PathVariable Long id) {
        manageInventoryUseCase.deleteInventory(id);
    ...
    public ResponseEntity<List<IngredientDto>> getAllIngredients() {
        return ResponseEntity.ok(manageIngredientUseCase.getAllIngredients());
    }
    ...
    public ResponseEntity<Page<IngredientDto>> getAllIngredientsPaged(
        ...
        Page<IngredientDto> ingredients = manageIngredientUseCase.getAllIngredientsPaginated(page, size);
    ...
    public ResponseEntity<Slice<IngredientDto>> getAllIngredientsInfiniteScroll(
        ...
        Slice<IngredientDto> ingredients = manageIngredientUseCase.getAllIngredientsSlice(page, size);
    ...
    public ResponseEntity<IngredientDto> getIngredientById(
            ...
            @PathVariable Long id) {
        return ResponseEntity.ok(manageIngredientUseCase.getIngredientById(id));
    }
    ...
    public ResponseEntity<IngredientDto> createIngredient(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(manageIngredientUseCase.createIngredient(dto));
    }
    ...
    public ResponseEntity<IngredientDto> updateIngredient(
            ...
            @RequestBody IngredientDto dto) {
        return ResponseEntity.ok(manageIngredientUseCase.updateIngredient(id, dto));
    }
    ...
    public ResponseEntity<Void> deleteIngredient(
            @Parameter(description = "ID ингредиента", required = true, example = "1")
            @PathVariable Long id) {
        manageIngredientUseCase.deleteIngredient(id);
        return ResponseEntity.noContent().build();
    }
}
