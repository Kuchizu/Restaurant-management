...
public class SupplierController {
    ...
    public ResponseEntity<Page<SupplierDto>> getAllSuppliersPaged(
        ...
        Page<SupplierDto> suppliers = supplierService.getAllSuppliersPaginated(page, size);
    ...
    public ResponseEntity<Slice<SupplierDto>> getAllSuppliersInfiniteScroll(
        ...
        Slice<SupplierDto> suppliers = supplierService.getAllSuppliersSlice(page, size);
    ...
    public ResponseEntity<Page<SupplyOrderDto>> getAllSupplyOrdersPaged(
        ...
        Page<SupplyOrderDto> orders = supplierService.getAllSupplyOrdersPaginated(page, size);
    ...
    public ResponseEntity<Slice<SupplyOrderDto>> getAllSupplyOrdersInfiniteScroll(
        ...
        Slice<SupplyOrderDto> orders = supplierService.getAllSupplyOrdersSlice(page, size);
